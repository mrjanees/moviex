...
import '../landscape_screens/home_screen.dart';

final controller = CarouselController();
final homecontrollers = Get.put(HomeControllers());
late double maxHeightDevice;
late double maxWidthDevice;
  ...
  Widget build(BuildContext context) {
    ...
    return orientation == Orientation.portrait
        ? LayoutBuilder(builder: (context, constraints) {
            ...
            maxHeightDevice = constraints.maxHeight;
            maxWidthDevice = constraints.maxWidth;
